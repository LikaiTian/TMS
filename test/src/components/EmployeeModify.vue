...
export default {
  ...
  created() {
    ...
    this.EmployeeForm.name = this.$route.query.name;
    this.EmployeeForm.department = this.$route.query.dept;
    this.EmployeeForm.job = this.$route.query.job;
    this.EmployeeForm.birth = this.$route.query.birth;
    this.EmployeeForm.phone = this.$route.query.phone;
    this.EmployeeForm.cardId = this.$route.query.cardId;
    this.EmployeeForm.sex = this.$route.query.sex;
    this.EmployeeForm.salary = this.$route.query.salary;
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs.EmployeeModFormRef.validate(async (valid) => {
        //验证失败
        if (!valid) return;
        await this.$http
          .get(
          ...
          .then((res) => {
            ...
            if (res.data.code == 0) {
              ...
              this.Operation = "修改员工" + this.EmployeeForm.name.toString();
